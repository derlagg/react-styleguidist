...
const getQuery = (options = {}) => (0, _qss.encode)(Object.assign({}, query, options), '?');
...
`;
  ...
  const result = _examplesLoader.default.call({
    query: getQuery(),
    _styleguidist: {}
  }, exampleMarkdown);
...
it('should prepend example code with React require()', () => {
  ...
  expect(result).toBeTruthy();
  expect(() => new Function(result)).not.toThrowError(SyntaxError);
  expect(result).toMatch(`const React$0 = require('react');\\nconst React = React$0.default || React$0;`);
});
it('should prepend example code with component require()', () => {
  ...
  expect(result).toBeTruthy();
  expect(() => new Function(result)).not.toThrowError(SyntaxError);
  expect(result).toMatch(`const FooComponent$0 = require('../foo.js');\\nconst FooComponent = FooComponent$0.default || FooComponent$0;`);
});
