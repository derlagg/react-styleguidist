...
var _chunkify = _interopRequireDefault(require("../chunkify"));
...
\`\`\`
`;
  const actual = (0, _chunkify.default)(markdown);
...
`;
  ...
  const actual = (0, _chunkify.default)(markdown, updateExample);
  expect(actual).toEqual(expected);
});
...
\`\`\`
`;
  const actual = (0, _chunkify.default)(markdown, undefined, ['vue']);
  expect(actual).toMatchSnapshot();
});
...
\`\`\`
`;
  const actual = (0, _chunkify.default)(markdown, undefined, undefined);
  expect(actual).toMatchSnapshot();
});