...
var _expandDefaultComponent = _interopRequireDefault(require("../expandDefaultComponent"));
...
`;
  const result = (0, _expandDefaultComponent.default)(exampleMarkdown, 'FooComponent');
