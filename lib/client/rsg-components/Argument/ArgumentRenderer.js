...
export function ArgumentRenderer(_ref2) {
  ...
  }, props), returns && 'Returns', name && React.createElement("span", null, React.createElement(Name, null, name), type && ':'), type && React.createElement(Type, null, type.name, isOptional && '?', !!defaultValue && "=" + defaultValue), type && description && " \u2014 ", description && React.createElement(Markdown, {
    text: "" + description,
    inline: true
  }));
}
